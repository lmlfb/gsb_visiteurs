				...
				echo "
					...
					foreach ($resultFICHE as $key => $value) {
						...
						foreach ($value as $key2 => $value2) {
								...
								echo "<td class=Tabtd>";
								if($value2=='ETP')echo "Forfait Etape";
								if($value2=='KM')echo "Frais kilomètrique";
								if($value2=='NUI')echo "Nuitée Hôtel";
								if($value2=='REP')echo "Repas Restaurant";
								//else{echo "$value2";}
								echo "</td>";
								switch ($value2) {
								    case "ETP":
...
<head>
	<title>Insert</title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="../css/afficher.css?<?php echo time(); ?>">
</head>
<body>
